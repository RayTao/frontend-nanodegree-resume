var resumeGlobalVars = (function () {
    ...
    var bio = {
        ...
        skills: ["swift", "objective-c", "JS", "programming"],
    ...
    var projects = {
        ...
        display: function () {
            ...
            projects.projects.forEach(function (project) {
                ...
                [formattedTitle, formattedDates, formattedDes].forEach(function (element) {
                    projectEntry.append(element);
                });
                project.images.forEach(function (image) {
                    var formattedImg = HTMLprojectImage.replace(placeholderKey, image);
                    projectEntry.append(formattedImg);
                });
            });
        }
    };
    ...
    var education = {
        ...
        display: function () {
            ...
            education.onlineCourses.forEach(function (onlineCourse) {
                ...
                var schoolName = HTMLonlineSchool.replace(placeholderKey, onlineCourse.school);
